        ...
        const episodeCard = `
            <div class="bg-gray-800/50 border border-gray-700/50 rounded-lg overflow-hidden shadow-lg hover:shadow-brand-accent-500/30 transition-shadow duration-300 flex flex-col h-full">
                ...
                <div class="p-6 pt-0 mt-auto">
                     <a href="episoden/${episode.id}.html" class="inline-block bg-brand-accent-500 text-white font-bold py-2 px-4 rounded-lg text-sm hover:bg-brand-accent-600 transition-colors">
                        Details & Quellen
                    </a>
                </div>
            </div>
